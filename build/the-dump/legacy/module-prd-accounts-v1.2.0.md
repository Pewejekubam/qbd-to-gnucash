...
**Module Identifier:** accounts-prd-v1.2.0.md
...
# Core dispatch payload conforming to core_dispatch_payload_v1
payload = {
    'section': '!ACCNT',
    'records': [{'NAME': 'Cash', 'ACCNTTYPE': 'BANK', 'DESC': 'Primary checking account'}],
    'output_dir': 'output/',
    'extra_config': {'strict_validation': True}
}

success = run_accounts_pipeline(payload)
# Returns bool per Core PRD Section 11.6 standards
if success:
