...
The horizontal rule (`---`) must not be used elsewhere in the document (e.g., within subsections or for thematic breaks).
...
11. Numbering Example <Note to Editor: This list need refactoring>
